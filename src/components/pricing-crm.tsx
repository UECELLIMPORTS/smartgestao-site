...
import { whatsappLink, PLANOS_CRM, ANNUAL_DISCOUNT, annualPricing, BRAND } from '@/lib/contact'
      ...
      <div className="container-x">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight" style={{ color: '#E8F0FE' }}>
            ...
            <span style={{ color: '#8AA8C8' }}>sem virar caos.</span>
          </h2>
          <p className="mt-4 text-base leading-relaxed" style={{ color: '#8AA8C8' }}>
            Centralize WhatsApp, segmenta leads e dispara mensagens em massa do seu próprio número.
        ...
        <div className="mt-10 flex items-center justify-center gap-3">
          <button onClick={() => setAnnual(false)}
            ...
            style={{ color: !annual ? '#E8F0FE' : '#8AA8C8' }}>Mensal</button>
            ...
            return (
              <article key={key}
                ...
                {annual ? (
                  ...
                  <p className="mt-2 text-xs" style={{ color: '#8AA8C8' }}>Cobrança mensal recorrente. Sem fidelidade.</p>
                )}
                ...
                <a
                  href={whatsappLink(`Oi! Tenho interesse no CRM ${plan.name} (${annual ? 'anual' : 'mensal'}).`)}
                ...
                <a
                  href={whatsappLink(`Oi! Quero saber mais sobre o CRM ${plan.name}.`)}
                  target="_blank" rel="noopener noreferrer"
        ...
        {/* Anchoring: já tem Gestão Smart Premium? */}
        <div className="mt-12 max-w-3xl mx-auto rounded-2xl border p-6 lg:p-8 text-center"
          style={{ background: '#0D1320', borderColor: 'rgba(79, 70, 229, .35)' }}>
          <div className="inline-flex items-center gap-2 rounded-full border px-3 py-1 text-[10px] font-bold uppercase tracking-widest mb-3"
            ...
            Já usa Gestão Smart Premium?
          </div>
          <h3 className="text-xl sm:text-2xl font-bold leading-tight" style={{ color: '#E8F0FE' }}>
            CRM Premium <span style={{ color: '#A5B4FC' }}>já vem incluso</span> — sem custo extra
          </h3>
          <p className="mt-2 text-sm" style={{ color: '#8AA8C8' }}>
            O plano Gestão Smart Premium (R$ 197/mês) já entrega o CRM Premium completo (R$ 157 valor à parte).
            Estes planos isolados são pra quem <strong style={{ color: '#E8F0FE' }}>não tem o ERP</strong> e quer só o CRM.
          </p>
          <a href="/" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold underline-offset-2 hover:underline"
            style={{ color: '#A5B4FC' }}>
            Ver Gestão Smart Premium <ArrowRight className="h-4 w-4" />
          </a>
        </div>
      </div>
    </section>
